...
export const AuthProvider = ({ children }) => {
  ...
  const userAuthentication = async () => {
    try {
      const response = await fetch("https://mern-with-admin-panel.vercel.app/api/auth/user", {
        method: "GET",
        headers: {
  ...
  const getServices= async()=>{
    try {
      const response = await fetch("https://mern-with-admin-panel.vercel.app/api/data/service/",{
        method:"GET",
      })
      if(response.ok)
      {
